...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-24 pb-32 bg-gradient-to-br from-green-50 via-white to-blue-50 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-left">
              <div className="mb-6">
                <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full text-sm font-semibold text-green-700 border border-green-200 shadow-sm">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-[1.1]">
                ...
                <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent"> 30 minutes</span>
              </h1>
            ...
            <div className="relative">
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 transform hover:scale-105 transition-transform duration-300">
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900">Client Message</div>
                        <div className="text-xs text-gray-500">2 min ago</div>
                      </div>
                    </div>
                    <span className="px-3 py-1 bg-red-100 text-red-700 text-xs font-semibold rounded-full">Urgent</span>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-4 border-l-4 border-red-400">
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-xl p-4 border border-green-200">
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        <div className="font-semibold text-gray-900 mb-2">Professional Response</div>
                        <p className="text-gray-700 text-sm leading-relaxed">
                    ...
                    <div className="flex gap-2 flex-wrap">
                      <span className="px-3 py-1 bg-green-600 text-white rounded-lg text-xs font-semibold">Professional</span>
                      <span className="px-3 py-1 bg-white text-gray-600 rounded-lg text-xs font-semibold border border-gray-200">Scope Management</span>
                      <span className="px-3 py-1 bg-white text-gray-600 rounded-lg text-xs font-semibold border border-gray-200">Boundary Setting</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">
              ...
              <span className="text-gray-600">Nothing platform-specific.</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-gradient-to-br from-green-50 to-white rounded-2xl p-8 border border-gray-200 hover:border-green-300 hover:shadow-xl transition-all">
              <div className="w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Freelancer-Specific AI</h3>
            ...
            <div className="group bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 border border-gray-200 hover:border-blue-300 hover:shadow-xl transition-all">
            ...
            <div className="group bg-gradient-to-br from-purple-50 to-white rounded-2xl p-8 border border-gray-200 hover:border-purple-300 hover:shadow-xl transition-all">
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 via-green-50 to-blue-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl shadow-2xl p-12 md:p-16 text-center border border-gray-100">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="mt-6 text-sm text-gray-500">No credit card required • Free to start</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="text-center md:text-left">
              <Link href="/" className="inline-block mb-4">
                <span className="text-2xl font-bold bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">FREELANCEFLOW</span>
              </Link>
            ...
            <div className="flex gap-12">
              <div>
                ...
                <ul className="space-y-3">
                  <li><Link href="#features" className="text-sm text-gray-600 hover:text-green-600 transition-colors">Features</Link></li>
                  <li><Link href="/pricing" className="text-sm text-gray-600 hover:text-green-600 transition-colors">Pricing</Link></li>
                </ul>
              </div>
            </div>
          </div>
