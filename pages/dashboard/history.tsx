      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
        {isLoading ? (
          <div className="p-12 text-center">
            <div className="inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-green-600 dark:border-green-500 border-r-transparent"></div>
          ...
          <div className="p-12 text-center">
            ...
            <button
              onClick={() => refetch()}
              className="mt-4 px-4 py-2 bg-green-600 dark:bg-green-500 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-600"
            >
              Try Again
            </button>
          </div>
          ...
          <div className="p-12 text-center">
            ...
            <button
              onClick={handleNewResponse}
              className="mt-6 px-6 py-2 bg-green-600 dark:bg-green-500 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-600 font-medium"
            >
                ...
                <div className="flex justify-between items-start gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-2 flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
                      ...
                      {item.context?.messageType && (
                        <span className="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded font-medium">
                          {item.context.messageType}
                        </span>
                      )}
                      ...
                      {item.context?.urgency && (
                        <span className={`px-2 py-1 rounded font-medium ${
                          item.context.urgency === 'urgent' ? 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200' :
                          item.context.urgency === 'standard' ? 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200' :
                  ...
                  <div className="flex gap-2 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-sm text-white bg-green-600 dark:bg-green-500 rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors"
                    >
                      View
                    </button>
                  </div>
