  ...
  const handleUpgrade = async (tier: 'professional' | 'premium', interval: 'monthly' | 'annual') => {
    ...
    try {
      ...
      if (canUpdateExisting) {
        // Update existing subscription (also handles resubscription for cancelled subs)
        ...
        if (isCancelPending && currentTier === tier) {
          ...
          toast.success(`Successfully ${currentTier === 'premium' ? 'switched to' : 'upgraded to'} ${tier}!`);
        }
    ...
    <SettingsLayout>
      ...
      >
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          {/* Professional Plan */}
          <div className={`rounded-lg border-2 p-4 ${
            isProfessional && !isCancelPending ? 'border-green-500 bg-green-50 dark:bg-green-900/20' : 'border-gray-200 dark:border-gray-700'
          }`}>
            ...
            {isProfessional && !isCancelPending ? (
              ...
              <button
                ...
                className={`mt-3 w-full px-3 py-2 text-sm font-medium rounded-lg ${
                  isPremium
      ...
      {showUpgradeModal && selectedPlan && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6 shadow-xl">
            ...
            {/* Proration Preview for existing subscribers */}
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-blue-900 dark:text-blue-100">
                        {prorationPreview.data.isUpgrade ? 'Upgrade' : 'Downgrade'} Billing Summary
                      </span>
                    </div>
                    ...
                    <div className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                      ...
                      ) : prorationPreview.data.isCredit ? (
                        <>
                          <p>
                            <span className="font-medium">Account credit:</span>{' '}
                            <span className="font-bold text-green-600 dark:text-green-400">${prorationPreview.data.prorationAmountFormatted}</span>
                          </p>
                          <p className="text-blue-600 dark:text-blue-400 text-xs">
                            This credit will be applied to your future invoices.
                          </p>
                        </>
                      ) : (
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                disabled={loading || (hasActiveSubscription && !isCancelPending && prorationPreview.isLoading)}
