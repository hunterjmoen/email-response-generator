          ...
          <div key={i} className="flex items-start gap-3">
            ...
            <div className="flex-1 space-y-2">
              <div className="animate-pulse space-y-2">
                ...
                {/* Message bubble skeleton */}
                <div className="bg-gray-100 dark:bg-gray-800 rounded-2xl rounded-tl-sm px-5 py-4 space-y-2">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold ${
                    response.confidence >= 0.8 ? 'bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300' :
                    response.confidence >= 0.6 ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300' : 'bg-orange-100 dark:bg-orange-900 text-orange-700 dark:text-orange-300'
                  }`}>
                ...
                <div
                  ...
                  className={`group relative rounded-2xl rounded-tl-sm px-5 py-4 cursor-pointer transition-all duration-200 ${
                    isSelected
                      ? 'bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/30 dark:to-blue-900/30 border-2 border-green-400 dark:border-green-500 shadow-lg'
                      : 'bg-gray-50 dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 hover:border-green-300 dark:hover:border-green-600 hover:shadow-md'
                  }`}
                >
                  {/* Selected Indicator */}
                  {isSelected && (
                    <div className="absolute -top-2 -right-2 bg-green-500 dark:bg-green-600 text-white rounded-full p-1 shadow-lg">
                  ...
                  {response.reasoning && (
                    <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                      ...
                      {expandedReasoning[index] && (
                        <div className="mt-2 pl-4 border-l-2 border-green-300 dark:border-green-600">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all font-medium text-sm ${
                      isCopied
                        ...
                        : 'bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-green-400 dark:hover:border-green-600'
                    }`}
                  >
                    {isCopied ? (
                      <>
