...
export function CopyPasteWorkflowComponent() {
  ...
  const handleStartNew = useCallback(() => {
    ...
    setSelectedResponseIndex(undefined);
    setError(null);
    setPromptInput('');
            ...
            <div className="absolute bottom-full left-0 mb-2 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 w-72">
              ...
              <dl className="space-y-2.5 text-sm">
                <div className="flex justify-between items-center">
                  ...
                  <dd className="font-mono text-xs bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded border border-gray-300 dark:border-gray-600 dark:text-gray-300">⌘ C</dd>
                </div>
                <div className="flex justify-between items-center">
                  <dt className="text-gray-600 dark:text-gray-400">New response</dt>
                  <dd className="font-mono text-xs bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded border border-gray-300 dark:border-gray-600 dark:text-gray-300">⌘ N</dd>
                </div>
                <div className="flex justify-between items-center">
                  <dt className="text-gray-600 dark:text-gray-400">Submit form</dt>
                  <dd className="font-mono text-xs bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded border border-gray-300 dark:border-gray-600 dark:text-gray-300">⌘ ↵</dd>
                </div>
                <div className="flex justify-between items-center">
