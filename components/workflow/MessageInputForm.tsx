        ...
        <div>
          ...
          <div className="relative">
            <textarea
              ...
              id="originalMessage"
              rows={6}
              className="w-full px-3 py-2 border border-white rounded-md shadow-sm focus:outline-none focus:border-white resize-vertical dark:bg-gray-900 dark:text-gray-100 dark:border-white"
