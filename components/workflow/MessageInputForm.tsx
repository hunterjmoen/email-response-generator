        ...
        <div>
          ...
          <div className="relative">
            <textarea
              ...
              id="originalMessage"
              rows={6}
              className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-vertical dark:bg-gray-700 dark:text-gray-100 ${
                errors.originalMessage ? 'border-red-300 dark:border-red-500' : 'border-gray-300 dark:border-gray-600'
              }`}
            ...
            <button
              ...
              className={`px-6 py-2 rounded-md text-white font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                isLoading || !isValid
                  ...
                  : 'bg-blue-600 hover:bg-blue-700 dark:bg-green-600 dark:hover:bg-green-700 focus:ring-blue-500 dark:focus:ring-green-500'
              }`}
            >
