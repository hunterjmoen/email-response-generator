...
export function SettingsLayout({ children }: SettingsLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Mobile menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden fixed inset-0 z-50 bg-gray-900 bg-opacity-50 dark:bg-opacity-80" onClick={() => setIsMobileMenuOpen(false)}>
                ...
                {navigationItems.map((item) => (
                  <Link
                    ...
                    className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all ${
                      isActive(item.href)
                        ? 'bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 font-medium shadow-sm'
